...
for instancia in instancias:
    if instancia == "d493.tsp":
        ...
        TabuSearch(matriz, f"resultados_v2/ejec 2/{instancia}/{instancia}.rdos", "Vecino mas cercano", 3, "2-opt", int(tam**0.7),int(tam**0.7)+1, tam**(1/3), optimo)
